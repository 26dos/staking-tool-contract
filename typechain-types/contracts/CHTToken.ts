...
export interface CHTTokenInterface extends utils.Interface {
  functions: {
    ...
    "lockTokensOnMinter(address,uint256,uint256)": FunctionFragment;
    "lockTokensOnStake(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lockTokensOnMinter",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>
  ...
  encodeFunctionData(
    functionFragment: "lockTokensOnStake",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>
  ...
  events: {
    ...
    "StakingContractSet(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "StakingContractSet"): EventFragment;
...
export interface StakingContractSetEventObject {
  stakingContract: string;
}
export type StakingContractSetEvent = TypedEvent<
  [string],
  StakingContractSetEventObject
>;

export type StakingContractSetEventFilter =
  TypedEventFilter<StakingContractSetEvent>;
...
export interface CHTToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CHTTokenInterface;
