...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const initializeTx = await Reward.initialize(filTokenAddress, CHTTokenDeployment.address, distributorAddress, { maxPriorityFeePerGas: ethers.BigNumber.from("5000000000") });
